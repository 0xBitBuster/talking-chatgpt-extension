const CHAT_TEXTAREA_SELECTOR = ".m-0.w-full.resize-none.border-0.bg-transparent.p-0.pr-7.focus\\:ring-0.focus-visible\\:ring-0.dark\\:bg-transparent.pl-2";
...
const sttBtnHTML = `
<a id="chatgpt-stt-btn" onclick="toggleSTT()" class="absolute rounded-md text-gray-500 bottom-1.5 md:bottom-2.5 hover:bg-gray-100 dark:hover:text-gray-400 dark:hover:bg-gray-900 cursor-pointer" style="right: 2.6rem; padding: 4px 6px">
